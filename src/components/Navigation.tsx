...
export default function Navigation({ activeTab, setActiveTab, session, isOnline, onOpenAuth, onOpenSettings, onSignOut, metadata, expenses = [], screenSize }: NavigationProps) {
  ...
  return (
    <>
      ...
      <IonModal isOpen={showMoreDrawer} onDidDismiss={() => setShowMoreDrawer(false)} className="ja-more-modal" swipeToClose={true} enterAnimation={moreDrawerEnterAnimation} leaveAnimation={moreDrawerLeaveAnimation} style={{ "--width": "100vw", "--max-width": "100vw", "--min-width": "260px", "--height": "85dvh", "--border-radius": "0", "--box-shadow": "8px 0 32px rgba(0,0,0,0.3)", "--backdrop-opacity": "0.5" } as React.CSSProperties}>
