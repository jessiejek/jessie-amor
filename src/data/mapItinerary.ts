...
const buildKaohsiungMapItinerary = (): MapItineraryData => ({
  ...
  days: [
    ...
    },
    {
      day: 21,
      label: "October 21",
      title: "Day 5 - October 21 - Full Day + Evening Departure",
      destinations: [
        { id: "21-1", name: "Neiwei Art Center", lat: 22.6820, lng: 120.2940, time: "9:45 AM", notes: "Full day free until the 8:00 PM flight — start with the farthest stops." },
        { id: "21-2", name: "Neiwei Cultural Park", lat: 22.6800, lng: 120.2955, time: "10:30 AM", notes: "" },
        { id: "21-3", name: "Kaohsiung Museum of Fine Arts", lat: 22.6656, lng: 120.2926, time: "11:15 AM", notes: "" },
        { id: "21-4", name: "Kaohsiung LRT Green Tunnel", lat: 22.6598, lng: 120.2930, time: "12:00 PM", notes: "" },
        { id: "21-5", name: "Sunfong Temple", lat: 22.6750, lng: 120.2970, time: "12:30 PM", notes: "" },
        { id: "21-6", name: "Hamasen Museum of Railway", lat: 22.6234, lng: 120.2822, time: "2:30 PM", notes: "" },
        { id: "21-7", name: "Great Harbour Bridge Kaohsiung", lat: 22.6215, lng: 120.2836, time: "3:15 PM", notes: "" },
        { id: "21-8", name: "Dayi Wharf Kaohsiung", lat: 22.6198, lng: 120.2851, time: "3:45 PM", notes: "" },
        { id: "21-9", name: "Kaohsiung Music Center", lat: 22.6178, lng: 120.2865, time: "4:15 PM", notes: "" },
        { id: "21-10", name: "Hub Hotel Kaohsiung Yisin Branch", lat: 22.5975, lng: 120.3096, time: "5:00 PM", notes: "Collect stored luggage." },
        { id: "21-11", name: "Dream Mall Kaohsiung", lat: 22.5904, lng: 120.2989, time: "5:45 PM", notes: "Last-minute shopping, ~10-15 min from the airport." },
        { id: "21-12", name: "Kaohsiung International Airport", lat: 22.5771, lng: 120.3500, time: "7:00 PM", notes: "Check-in, security. Flight KHH -> MNL departs 8:00 PM, arrives 9:55 PM." },
      ],
    },
  ],
});
