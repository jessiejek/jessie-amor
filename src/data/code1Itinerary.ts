      ...
      items: [
        {
          ...
          title: 'Wake up',
          category: 'hotel',
          description: [text('Wake up refreshed and get ready for an early start.')],
          tags: [tag('Rest', 'hotel')],
          mapQuery: 'Travelodge Kuala Lumpur City Centre',
        },
        {
          time: '5:30 AM',
          id: 'day13-breakfast-yusoof-zakhir',
          guideKey: 'restoran-yusoof-dan-zakhir',
          title: 'Light breakfast',
          category: 'food',
          description: [text('Step out of Travelodge to Restoran Yusoof Dan Zakhir right next door. Grab a quick, hot Roti Canai and Teh Tarik to fuel up.')],
          tags: [tag('Food', 'food')],
          mapQuery: 'Restoran Yusoof Dan Zakhir Kuala Lumpur',
        },
        {
          time: '5:50 AM',
          id: 'day13-walk-to-pasar-seni',
          guideKey: 'lrt-pasar-seni-to-kl-sentral',
          title: 'Walk to Pasar Seni LRT Station',
          category: 'train',
          description: [text('Walk right behind your hotel into Pasar Seni LRT Station. Take the Kelana Jaya Line 1 stop to KL Sentral (approx. 3 minutes).')],
          tags: [tag('Walk', 'walk')],
          mapQuery: 'Pasar Seni LRT Station',
        },
        {
          time: '6:00 AM',
          id: 'day13-transfer-kl-sentral',
          guideKey: 'ktm-komuter-to-batu-caves',
          title: 'Transfer to KTM Komuter',
          category: 'train',
          description: [text('Tap out of the LRT gates at KL Sentral and follow the blue overhead signs pointing to the KTM Komuter departure gates. Buy a cash token or tap your Touch \'n Go card at the turnstiles for the Batu Caves Line.')],
          tags: [tag('Train', 'train')],
        ...
        },
        {
          ...
          category: 'train',
          description: [text('Walk down to the platform and locate the train. Keep an eye out for the Ladies-Only coaches if you want a quieter ride.')],
          tags: [tag('Train', 'train')],
          mapQuery: 'KL Sentral Station',
        },
        {
          time: '6:25 AM',
          id: 'day13-early-train',
          guideKey: 'ktm-komuter-to-batu-caves',
          title: 'Catch the early train',
          category: 'train',
          description: [text('Board the early morning KTM Komuter train. The train ride is a direct, peaceful 32-minute journey that cuts straight through the northern suburbs of the city.')],
          tags: [tag('Train', 'train')],
          mapQuery: 'Batu Caves',
        },
        {
          time: '7:00 AM',
          id: 'day13-arrive-batu-caves',
          guideKey: 'batu-caves',
          title: 'Arrive at Batu Caves',
          category: 'spot',
          description: [text('Step off the train at the Batu Caves KTM Station. The temple gates and the giant golden statue are located just a short 2-minute flat walk right outside the station exit.')],
          tags: [tag('Spot', 'spot'), tag('Free', 'free')],
          mapQuery: 'Batu Caves',
        },
        {
          time: '8:30 AM',
          id: 'day13-genting-island',
          guideKey: 'genting-island-transfer',
          title: 'Go to Genting Island',
          category: 'train',
          description: [text('Option A: Order a direct Grab car right from the Batu Caves lot straight to the Awana SkyCentral cable car station. Option B: Take a 10-minute Grab to Gombak LRT Station and hop on a pre-booked express bus heading up the mountain.')],
          tags: [tag('Grab', 'hotel')],
          mapQuery: 'Awana SkyCentral',
        },
        {
          time: '9:30 AM',
          id: 'day13-cable-car-chin-swee',
          guideKey: 'chin-swee-caves-temple',
          title: 'Cable Car & Misty Mountain Temple',
          category: 'spot',
          description: [text('Board the Awana SkyWay cable car. Use the free midway stop to hop off at Chin Swee Station. Walk the peaceful, misty terraces of the Chin Swee Caves Temple and take photos by its iconic 9-story pagoda.')],
          tags: [tag('Spot', 'spot')],
          mapQuery: 'Chin Swee Caves Temple',
        },
        {
          time: '11:00 AM',
          id: 'day13-skyavenue-lunch',
          guideKey: 'skyavenue-mall',
          title: 'Peak Exploration & SkyAvenue Lunch',
          category: 'food',
          description: [text('Ride the cable car to the peak inside SkyAvenue Mall. Grab a beautiful lunch at an aesthetic café, check out the futuristic indoor neon tracks of Skytropolis, or ride back down one stop for an open-air retail walk at the Genting Highlands Premium Outlets.')],
          tags: [tag('Food', 'food')],
          mapQuery: 'SkyAvenue Mall',
        },
        {
          time: '4:30 PM',
          id: 'day13-return-to-kl',
          guideKey: 'genting-island-transfer',
          title: 'Return to Kuala Lumpur & Refresh',
          category: 'train',
          description: [text('Take the cable car back down to the base and grab an express bus or a Grab car straight back to Travelodge to quickly drop off any mountain gear, freshen up, and prepare for your night out.')],
          tags: [tag('Grab', 'hotel')],
          mapQuery: 'Travelodge Kuala Lumpur City Centre',
        },
        {
        ...
        },
        {
          ...
          category: 'train',
          description: [text('What to look for: Don\'t miss the famous Wong Ah Wah grilled chicken wings, sizzling satay skewers, or a refreshing plate of local coconut ice cream. Return to Pasar Seni via MRT for a well-deserved, deep sleep.')],
          tags: [tag('MRT', 'train')],
      ...
      items: [
        {
          ...
          title: 'Wake up',
          category: 'hotel',
          description: [text('Wake up and get ready for the Melaka day trip.')],
          tags: [tag('Hotel', 'hotel')],
          mapQuery: 'Travelodge Kuala Lumpur City Centre',
        },
        {
          ...
          description: [text('Quick Morning Breakfast.')],
          tags: [tag('Food', 'food')],
          mapQuery: 'Travelodge Kuala Lumpur City Centre',
        },
        {
          time: '6:15 AM',
          id: 'day14-transit-to-melaka',
          guideKey: 'bus-to-melaka-sentral',
          title: 'Transit to Melaka',
          category: 'train',
          description: [text('Walk behind your hotel into Pasar Seni Station. Take the rail link down to Terminal Bersepadu Selatan (TBS) and board your morning express bus straight down to Melaka (approx. 2 hours).')],
          tags: [tag('Train', 'train')],
          mapQuery: 'TBS Terminal Bersepadu Selatan',
        },
        {
          time: '9:30 AM',
          id: 'day14-historic-red-core',
          guideKey: 'dutch-square-red-square',
          title: 'The Historic Red Core & Sultanate Palace',
          category: 'spot',
          description: [text('Explore Dutch Square, walk up St. Paul\'s Hill, and tour the striking wooden architecture of the Melaka Sultanate Palace Museum.')],
          tags: [tag('Spot', 'spot')],
        ...
        },
        {
          ...
          description: [text('Cross the river into the historic townhouse lanes of Jonker Street. Sit down at a heritage café for traditional Melaka chicken rice balls or an authentic Nyonya lunch. Afterward, tour the beautifully preserved Baba & Nyonya Heritage Museum to see the stunning inner courtyards and antique collections of an old affluent estate.')],
          tags: [tag('Food', 'food')],
        ...
        },
        {
          ...
          category: 'spot',
          description: [text('Exploration Walk back toward the river mouth to explore the Maritime Museum, uniquely housed entirely inside a massive, towering replica of the historic Portuguese ship Flor de la Mar.')],
          tags: [tag('Spot', 'spot')],
        ...
        },
        {
          ...
          category: 'spot',
          description: [text('Step right onto the boat at the Melaka River Cruise Jetty located directly adjacent to the ship museum. This 45-minute round-trip boat ride provides a beautiful, breezy break from walking.')],
          tags: [tag('Spot', 'spot')],
          mapQuery: 'Melaka River Cruise Jetty',
        },
        {
          time: '3:30 PM',
          id: 'day14-riverside-walk',
          guideKey: 'melaka-river-walk',
          title: 'Riverside Walk & Coffee Break',
          category: 'walk',
          description: [text('Step off the boat and take a slow stroll along the clean, tree-shaded wooden boardwalks. Find a small, hidden riverside cafe to enjoy an ice-cold local drink or a signature Nyonya Cendol right next to the water.')],
          tags: [tag('Walk', 'walk')],
          mapQuery: 'Melaka River Walk',
        },
        {
          time: '5:00 PM',
          id: 'day14-floating-mosque',
          guideKey: 'melaka-straits-mosque',
          title: 'Golden Hour at the Floating Mosque',
          category: 'spot',
          description: [text('Take a quick 10-minute Grab car over to the Melaka Straits Mosque on Malacca Island. Walking the perimeter platforms right as the late afternoon sun casts a warm glow over its gold-and-blue dome over the sea is the ultimate grand finale to your sightseeing.')],
          tags: [tag('Spot', 'spot')],
          mapQuery: 'Melaka Straits Mosque',
        },
        {
          time: '5:30 PM',
          id: 'day14-transit-to-melaka-sentral',
          guideKey: 'bus-to-tbs',
          title: 'Transit to Melaka Sentral',
          category: 'bus',
          description: [text('Take your comfortable express bus transit from Melaka Sentral back to TBS terminal in KL, then hop onto the rail straight back to Pasar Seni Station.')],
          tags: [tag('Bus', 'bus')],
        ...
        },
        {
          ...
          category: 'bus',
          description: [text('Board your evening express bus for a smooth, air-conditioned ride back to the TBS terminal in KL, then catch the rail link straight back to Pasar Seni Station.')],
          tags: [tag('Bus', 'bus')],
          mapQuery: 'Melaka Sentral',
        },
        {
          ...
          description: [text('Sit down for a comforting, easy late-night dinner right near the hotel to unwind from the travel day.')],
          tags: [tag('Food', 'food')],
          mapQuery: 'Travelodge Kuala Lumpur City Centre',
        },
        {
          ...
          title: 'Final Pack',
          category: 'hotel',
          description: [text('Head up to your room at Travelodge to smoothly pack your things, double-check your passports, and get a great night’s rest before your flight to Singapore the next morning.')],
          tags: [tag('Hotel', 'hotel')],
          mapQuery: 'Travelodge Kuala Lumpur City Centre',
        },
      ],
