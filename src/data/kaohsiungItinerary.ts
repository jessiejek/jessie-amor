...
const days: DaySectionData[] = [
  ...
  },
  {
    ...
    budgetLabel: "Full day free, 8:00 PM flight",
    items: [
      item({
        time: "8:00 AM",
        title: "Breakfast at Hub Hotel",
        category: "food",
        description: [text("Full day free until the evening flight — no rush this morning.")],
        tags: [tag("Food", "food")],
        mapQuery: "Hub Hotel Kaohsiung Yisin Branch",
        guideKey: "kh-departure-breakfast",
      }),
      item({
        ...
        category: "hotel",
        description: [text("Most hotels hold bags after checkout — confirm at the front desk. Come back for them in the late afternoon.")],
        tags: [tag("Hotel / Taxi", "hotel")],
        mapQuery: "Hub Hotel Kaohsiung Yisin Branch",
        guideKey: "kh-hub-hotel-checkin",
      }),
      ...
      item({
        ...
        category: "food",
        description: [text("Unhurried lunch — plenty of time before the flight.")],
        tags: [tag("Food", "food")],
      ...
      item({
        ...
        title: "Dayi Wharf",
        category: "spot",
        description: [place("Dayi Wharf", "waterfront", "Dayi Wharf Kaohsiung")],
        tags: [tag("Tourist spot", "spot")],
      ...
      item({
        time: "5:30 PM",
        title: "MRT: R8 Sanduo → R6 Qianzhen",
        category: "train",
      ...
      item({
        ...
        category: "hotel",
        description: [text("Flight KHH → MNL departs 8:00 PM, arrives 9:55 PM.")],
        tags: [tag("Hotel / Taxi", "hotel")],
        mapQuery: "Kaohsiung International Airport",
        guideKey: "kh-airport-departure",
      }),
