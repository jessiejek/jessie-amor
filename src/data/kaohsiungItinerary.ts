...
const hero: HeroData = {
  ...
  meta: ["MNL–KHH: Oct 17, 5:00–7:00 PM", "KHH–MNL: Oct 21, 8:00–9:55 PM", "Hub Hotel Yisin Branch, Oct 17–21", "Oct 20 — Amor's birthday 🎂", "No seafood"],
  note: [
    text(
...
const days: DaySectionData[] = [
  ...
  },
  {
    ...
    budgetLabel: "Free until early afternoon, airport by 4:00 PM",
    items: [
      item({
        time: "8:00 AM",
        title: "Breakfast at Hub Hotel",
        category: "food",
        description: [text("At the airport by 4:00 PM for the 8:00 PM flight — that's a full 4-hour buffer for check-in, immigration, and security. No rushing today.")],
        tags: [tag("Food", "food")],
        mapQuery: "Hub Hotel Kaohsiung Yisin Branch",
        guideKey: "kh-departure-breakfast",
      }),
      item({
        time: "9:00 AM",
        title: "Check out, store luggage at Hub Hotel",
        category: "hotel",
        description: [text("Most hotels hold bags after checkout — confirm at the front desk. Come back for them in the early afternoon.")],
        tags: [tag("Hotel / Taxi", "hotel")],
        mapQuery: "Hub Hotel Kaohsiung Yisin Branch",
        guideKey: "kh-hub-hotel-checkin",
      }),
      item({
        ...
        title: "MRT: R8 Sanduo → R16 Zuoying",
        category: "train",
        description: [text("~20 min — starting with the farthest stops first.")],
        tags: [tag("Train / MRT / LRT", "train")],
        mapQuery: "Zuoying MRT Station Kaohsiung",
        guideKey: "kh-mrt-to-zuoying",
      }),
      ...
      item({
        ...
        category: "spot",
        description: [place("LRT Green Tunnel", "photo spot", "Kaohsiung LRT Green Tunnel")],
        tags: [tag("Tourist spot", "spot")],
      ...
      item({
        time: "12:15 PM",
        title: "Lunch near Zuoying (non-seafood)",
        category: "food",
        description: [text("Keep it reasonably paced — the rest of the day is on a schedule that ends at the airport.")],
        tags: [tag("Food", "food")],
      ...
      item({
        time: "1:15 PM",
        title: "MRT: R16 Zuoying → R11 Kaohsiung Main Station",
        category: "train",
        description: [text("~20 min toward the harbor.")],
        tags: [tag("Train / MRT / LRT", "train")],
        mapQuery: "Kaohsiung Main Station",
        guideKey: "kh-mrt-to-harbor",
      }),
      ...
      item({
        ...
        category: "spot",
        description: [
          place("Dayi Wharf", "waterfront", "Dayi Wharf Kaohsiung"),
          text(" — last fixed stop. Kaohsiung Music Center and Dream Mall are worth it only if you're running ahead of this schedule; skip them without regret if not."),
        ],
        tags: [tag("Tourist spot", "spot")],
      ...
      item({
        time: "3:00 PM",
        title: "MRT back to Hub Hotel, collect luggage",
        category: "hotel",
        description: [text("R11 → R8 Sanduo, ~10 min, then pick up bags from the front desk.")],
        tags: [tag("Hotel / Taxi", "hotel")],
        mapQuery: "Hub Hotel Kaohsiung Yisin Branch",
        guideKey: "kh-hub-hotel-checkin",
      }),
      item({
        ...
        category: "train",
        description: [text("Red Line, direct, ~15-20 min.")],
        tags: [tag("Train / MRT / LRT", "train")],
        mapQuery: "Kaohsiung International Airport",
      ...
      item({
        time: "4:00 PM",
        title: "At the airport — check-in, immigration, security",
        category: "hotel",
        description: [text("4-hour buffer before an 8:00 PM flight. Flight KHH → MNL departs 8:00 PM, arrives 9:55 PM. Relax, grab dinner airside — no need to watch the clock.")],
        tags: [tag("Hotel / Taxi", "hotel")],
        mapQuery: "Kaohsiung International Airport",
        guideKey: "kh-airport-departure",
      }),
